...
@SourceType(value = "PinterestARP", label = "Pinterest",uiConfig = "pinterest-layout.json")
public class PinterestConf extends AbstractArpConf<PinterestConf> {
  private static final String ARP_FILENAME = "arp/implementation/pinterest-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.pinterest.PinterestDriver";
